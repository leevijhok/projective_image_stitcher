...
def stitchImagesFeatures(images):
    ...
    # Get homography:
    homographies = getHomographies(points2d_list1=points2d_list1, points2d_list2=points2d_list2)
...
def stitch_images_cv_iterative(images, batch_size=2):
    ...
    images_rgb = [cv2.cvtColor(image, cv2.COLOR_RGBA2RGB) if image.shape[2] == 4 else image for image in images]
